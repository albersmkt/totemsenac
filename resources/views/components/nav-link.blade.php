...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-senac-orange text-sm font-semibold leading-5 text-slate-900 focus:outline-none focus:border-senac-orange transition'
