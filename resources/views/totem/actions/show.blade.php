...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('totem.actions.index', $totemRouteParams) }}" class="px-5 py-2 rounded-full bg-senac-blue text-white font-semibold">Voltar</a>
    </div>
    ...
    <div class="grid grid-cols-1 gap-8">
        <div class="totem-card">
            ...
            <div class="p-6 space-y-4">
                ...
                <p class="text-lg text-slate-700 leading-relaxed">{!! nl2br(e($action->description)) !!}</p>
            </div>
        </div>
    </div>
@endsection
